package com.moran.music.database;
...
public class SqliteHandle {
    ...
    private static final String DATABASE_CREATE =
            "create table music (_id integer primary key autoincrement, "
                    + "title text not null, artist text not null, duration text not null, uri text not null, album text not null);";
    ...
    public long insertMusic(String title, String artist, String album, int duration, String urid) {
        ...
        //initialValues.put(KEY_IMAGE,albumid);
    ...
    public Cursor getAllMusic() {
        return db.query(DATABASE_TABLE, new String[]{KEY_NAME, KEY_ARTIST, KEY_ALBUM, KEY_DURATION,KEY_URI}, null, null, null, null, null);
    }
    ...
    public void clearAll(){
        String clearQuery= "DELETE FROM " + DATABASE_TABLE;
        try {
            db.execSQL(clearQuery);
        }catch (SQLException e){
            e.printStackTrace();
    ...
    //---updates a contact---
    public boolean updateMusic(long rowId, String title, String artist, String album, String duration, String urid) {
