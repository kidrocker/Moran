...
import com.moran.music.databases.SqliteHandle;
 ...
 */
public class ViewSong extends Activity {
    RecyclerView rc;
    Player musicSrv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new LocalAdapter(ViewSong.this,users);
